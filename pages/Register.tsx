...
export default function Register() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (strength.score >= 3 && passwordsMatch) {
            try {
                // Save email to localStorage so Unlock page can find it (for sprint 1 convenience)
            ...
            >
                <div className="glass-panel p-8 rounded-3xl">
                    ...
                    <div className="flex items-center justify-center mb-8">
                        <div className="w-20 h-20 bg-white/5 backdrop-blur-xl rounded-2xl flex items-center justify-center border border-white/10 overflow-hidden shadow-xl">
                            <img src="/logo.png" alt="Zero-Vault Logo" className="w-14 h-14 object-contain" />
                        </div>
                    </div>
