        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
            ...
            >
                ...
                <motion.div
                    ...
                    className="w-24 h-24 mx-auto mb-8 bg-white/5 backdrop-blur-3xl rounded-3xl flex items-center justify-center shadow-2xl shadow-primary/20 overflow-hidden"
                >
